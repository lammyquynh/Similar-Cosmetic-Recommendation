...
cosm = pd.read_csv('C:\\Users\quynh\Downloads\Cosmetic-master\data\cosmetic.csv')
cosm.info()
...
print(cosm_2)
# save the file
cosm_2.to_csv('C:\\Users\quynh\Downloads\Cosmetic-master\data\cosmetic_p.csv', encoding = 'utf-8-sig', index = False)
